...
export const mapFontToVariant: Record<Variant, string> = {
  ...
  small: 'text-[0.625rem] leading-[1rem]'
}
...
export const small = new VariantType(Variant.small).set({
  bold: `${mapFontToVariant[Variant.small]} font-bold`,
  regular: `${mapFontToVariant[Variant.small]} font-normal`,
  medium: `${mapFontToVariant[Variant.small]} font-medium`
})
