...
const NotFoundPage = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col m-auto mt-8 md:mt-28 mx-8 md:mx-0">
      <Typography size={Variant.H3} fontWeight="bold" className="text-primary mb-5 md:text-4xl">
      ...
      <Typography size={Variant.H3} fontWeight="bold" className="mt-8 text-center">
        The page you are trying to access doesn’t exist or has been moved. Try going back to our
        homepage.
      </Typography>
      <Typography size={Variant.Body2} fontWeight="bold" className="mt-1 md:text-base">
